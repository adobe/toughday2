...
public class TestFeederGetAnnotatedMethod extends TestCase {
    private Method TdFeederAnnotatedMethod;
    private Class classType;

    public TestFeederGetAnnotatedMethod(String testName, Method method) {
        super(testName);
        this.TdFeederAnnotatedMethod = method;
    }

    public TestFeederGetAnnotatedMethod(String testName, Class classType) {
        super(testName);
    ...
    public void testModifier() {
        assertTrue("ToughDay2 feeder get method \"" + TdFeederAnnotatedMethod + "\" must be public",
                (TdFeederAnnotatedMethod.getModifiers() & Modifier.PUBLIC) != 0);
    }

    public void testArguments() {
        assertTrue( "ToughDay2 feeder get method \"" + TdFeederAnnotatedMethod + "\" must have no parameters",
                TdFeederAnnotatedMethod.getParameterTypes().length == 0
        );
    }
