...
public class YamlDumpConfigurationAsTaskForTDAgentsTest {
    ...
    public void testNullCofigurationThrowsException() {
        ...
        new YamlDumpConfigurationAsTaskForTDAgents(null);
    }
    ...
    public void testCollectConfigurablePropertiesWithIncompatibleTypeThrowsException() throws Exception {
        ...
        YamlDumpConfigurationAsTaskForTDAgents yamlDumpConfiguration = new YamlDumpConfigurationAsTaskForTDAgents(configuration);
