...
import com.adobe.qe.toughday.internal.core.config.parsers.yaml.YamlBuilder;
import com.adobe.qe.toughday.internal.core.config.parsers.yaml.YamlDumpAddAction;
import com.adobe.qe.toughday.internal.core.config.parsers.yaml.YamlDumpPhase;
 ...
 */
public class YamlDumpConfigurationAsTaskForTDAgents {
        ...
        Arrays.stream(type.getDeclaredMethods())
                ...
                .forEach(method -> {
                    ...
                    try {
                        ...
                        LOG.warn("Configurable property " + property + " could not be collected when dumping the " +
                                "configuration. Please check that public methods with @ConfigArgSet and @ConfigArgGet " +
                                "were defined for this property.");
                    } catch ( NoSuchMethodException e) {
                        // skip for now
                        LOG.warn("No @ConfigArgGet method was defined for property " + property + ". The configuration " +
                                "will be dumped without this property.");
                    }
                });
    ...
    public YamlDumpConfigurationAsTaskForTDAgents(Configuration configuration) {
