...
public class YamlBuilder {
    ...
    private static void configureYamlRepresenterToExcludeClassTags(Representer representer) {
        ...
        representer.addClassTag(YamlDumpConfigurationAsTaskForTDAgents.class, Tag.MAP);
            ...
            protected NodeTuple representJavaBeanProperty(Object javaBean, Property property, Object propertyValue, Tag customTag) {
                ...
                if (method == null) {
                    ...
                    try {
                        ...
                        /* no action required here. The only implication is that the empty collection will be included
                         * in the Yaml representation when dumping an object.
                         */
                    }
